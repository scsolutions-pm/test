...
class Paypal_lib {
	...
	{ //echo $value;exit;
		...
		$this->submit_btn = "<input style='display:none' name='pp_submit' id='pp_submit' type='submit' value='{$value}'>";//form_submit('pp_submit', $value);
	}
	...
	function paypal_auto_form() 
	{
		...
		// another hidden form and submit to paypal.
                //echo $this->paypal_form('paypal_auto_form');exit;
		//$this->button('Click here if you\'re not automatically redirected...');

		//echo '<html>' . "\n";
		//echo '<head><title>Processing Payment...</title></head>' . "\n";
		//echo '<body style="text-align:center;" onLoad="document.forms[\'paypal_auto_form\'].submit();">' . "\n";
		$str = '<p class="wait_text">Please wait, your order is being processed and you will be redirected to the paypal website.</p>' . "\n";
		return $str.= $this->paypal_form('paypal_auto_form');
		//echo '</body></html>';
	}
