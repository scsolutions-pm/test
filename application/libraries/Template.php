...
class CI_Template {
   ...
   /**
	 * @var  CI The use default function
	 *
	 */
   var $CI;
   /**
	 * @var  config configure the value
	 *
	 */
   var $config;
   /**
	 * @var  template filename of new master template file
	 *
	 */
   var $template;
   /**
	 * @var  master  Load the template config file and setup our master template and regions
	 *
	 */
   var $master;
   /**
	 * @var  regions Loads template configuration, template regions, and validates existence of 
	 *
	 */
   var $regions = array(
      '_scripts' => array(),
   ...
   /**
	 * @var  output output the rendered template
	 *
	 */
   var $output;
   /**
	 *  @var  js  This function does NOT check for existence of .js file
	 *
	 */
   var $js = array();

   /**
	 *  @var  css  This function does NOT check for existence of .css file  
	 *
	 */
   var $css = array();

   /**
	 *  @var  parser Set parser and parser method
	 *
	 */
   var $parser = 'parser';

   /**
	 *  @var  parser_method Set parser and parser method
	 *
	 */
   var $parser_method = 'parse';

   /**
	 *  @var  parse_template  Set parser and parser template method
	 *
	 */
