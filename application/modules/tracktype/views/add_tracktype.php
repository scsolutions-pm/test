...
<div id="content">
    ...
    <div id="content-header">
        <div id="breadcrumb"> <a href="<?php echo site_url('tracktype'); ?>" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> <?php echo lang('home'); ?></a> <a href="#" class="current"><?php echo lang('add_track_type'); ?></a> </div>
    </div>
    <!--End-breadcrumbs-->
    <!--Action boxes-->
                    ...
                    <div class="widget-content nopadding">
                        <form action="" method="post" class="form-horizontal">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span11" placeholder="Enter Title" name="tracktype_name" value="<?php echo set_value('tracktype_name'); ?>">
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label"><?php echo lang('track_type_description'); ?></label>
                                <div class="controls">
                                    <textarea class="span11" name="tracktype_description"><?php echo set_value('tracktype_description'); ?></textarea>
                                </div>
                            </div>
                        <!--     <div class="control-group">
